"""Extended warehouse models for put-away rules and capacity management."""
import enum
...
class WarehouseExtended(Base, UUIDMixin, TimestampMixin, TenantMixin, AuditMixin):
    """Extended warehouse model with hierarchy and capacity."""
    ...
    parent_warehouse_id = Column(UUID(as_uuid=True), ForeignKey("warehouses_extended.id"), nullable=True)
